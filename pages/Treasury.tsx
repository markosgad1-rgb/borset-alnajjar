...
import { Wallet, Building2, Banknote, Trash2, AlertTriangle } from 'lucide-react';

export const Treasury: React.FC = () => {
  const { treasury, currentTreasuryBalance, balances, clearTreasury, currentUser } = useERP();
